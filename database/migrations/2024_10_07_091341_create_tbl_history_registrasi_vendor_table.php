...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbl_history_registrasi_vendor', function (Blueprint $table) {
            ...
            $table->string('kode_master_negara')->nullable();
            $table->bigInteger('kode_provinsi')->nullable();
            $table->foreignId('kode_kabupaten_kota')->nullable()->references('kode')->on('tbl_master_kab_kota');
            $table->foreignId('kode_kecamatan')->nullable()->references('kode')->on('tbl_master_kecamatan');
            $table->foreignId('kode_kelurahan')->nullable()->references('kode')->on('tbl_master_kelurahan');
            ...
            $table->string('no_pic_perorangan')->nullable();
