        ...
        <div class="row div-group-daftar-direksi">
            <div class="col-md-4 col-sm-12 mb-4">
                ...
                <input type="text" required maxlength="255"
                       class="form-control @error("daftar_direksi.{$key}.no_identitas_direksi") is-invalid @enderror" value="{{ $oldDaftarDireksi['no_identitas_direksi'] }}"
            ...
            <div class="col-md-4 col-sm-12 mb-4">
                ...
                <select type="text" required maxlength="255"
                        class="form-control @error("daftar_direksi.{$key}.kode_master_jenis_identitas_direksi") is-invalid @enderror" data-control="select2"
            ...
            <div class="col-md-4 col-sm-12 mb-4">
                ...
                <input type="text" required maxlength="255"
                       class="form-control @error("daftar_direksi.{$key}.nama_direksi") is-invalid @enderror" value="{{ $oldDaftarDireksi['nama_direksi'] }}"
            ...
            <div class="col-md-4 col-sm-12 mb-4">
                ...
                <textarea type="text" required maxlength="255"
                          class="form-control @error("daftar_direksi.{$key}.alamat_direksi") is-invalid @enderror" rows="1"
            ...
            <div class="col-md-4 col-sm-12 mb-4">
                ...
                <select required
                        class="form-control @error("daftar_direksi.{$key}.kode_master_jabatan_vendor_direksi") is-invalid @enderror" data-control="select2"
            ...
            <div class="col-md-4 col-sm-12 mb-7">
                ...
                <input type="date" required
                       class="form-control @error("daftar_direksi.{$key}.tanggal_lahir_direksi") is-invalid @enderror" value="{{ $oldDaftarDireksi['tanggal_lahir_direksi'] }}"
