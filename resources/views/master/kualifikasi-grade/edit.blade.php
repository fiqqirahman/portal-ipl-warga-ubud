                    ...
                    <div class="card card-flush h-lg-100">
                        <div class="card-header pt-7">
                            <div class="card-title">
                                ...
                                <h2>{{ $title }} {{ $stmtKualifikasiGrade->nama }}</h2>
                            </div>
                        </div>
                        <div class="card-body pt-5">
                            <form action="{{ route('master.kualifikasi-grade.update', enkrip($stmtKualifikasiGrade->id)) }}" class="form"
                                  id="form" method="POST">
                                @method('put')
                                @csrf
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text"
                                           ...
                                           name="nama" value="{{ old('nama', $stmtKualifikasiGrade->nama) }}" id="nama" />
                                    @error('nama')
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text"
                                           ...
                                           name="kode" value="{{ old('kode', $stmtKualifikasiGrade->kode) }}" id="kode" />
                                    @error('kode')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
