                    ...
                    <div class="card card-flush h-lg-100">
                        <div class="card-header pt-7">
                            <div class="card-title">
                                ...
                                <h2>{{ $title }} {{ $stmtJenisInventaris->nama }}</h2>
                            </div>
                        </div>
                        <div class="card-body pt-5">
                            <form action="{{ route('master.jenis-invetaris.update', enkrip($stmtJenisInventaris->id)) }}" class="form"
                                  id="form" method="POST">
                                @method('put')
                                @csrf
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text"
                                           ...
                                           name="nama" value="{{ old('nama', $stmtJenisInventaris->nama) }}" id="nama" />
                                    @error('nama')
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="number"
                                           ...
                                           name="kode" value="{{ old('kode', $stmtJenisInventaris->kode) }}" id="kode" />
                                    @error('kode')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
