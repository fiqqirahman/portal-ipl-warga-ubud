...
class JenisVendorDataTable extends DataTable
{
    /**
     ...
     */
    public function query(\App\Models\Master\JenisVendor $model): QueryBuilder
    {
    ...
    {
        return 'JenisVendor_' . date('YmdHis');
    }
}
